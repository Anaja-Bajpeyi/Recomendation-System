...
class popularity_recommender_py():#popularity_recommender_py
    def __init__(self):
    ...
    def create(self, train_data, user_id, item_id):
        ...
        train_data_grouped.rename(columns = {'Users': 'score'},inplace=True)
    ...
    def recommend(self, user_id):    
        ...
        user_recommendations['Users'] = user_id
...
class item_similarity_recommender_py():
    ...
    def generate_top_recommendations(self, user, cooccurence_matrix, all_products, user_products):
        ...
        columns = ['users', 'product', 'score', 'rank']
